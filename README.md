...
- NHÓM 20;
- THÀNH VIÊN : PHẠM KHÔI NGUYÊN - MSV: 21020083;
...
- ![](res/sprites/minvo_left1.png) *Minvo* là Enemy có tốc độ di chuyển cao ,sẽ duổi theo Bomber khi đến gần
- ![](res/sprites/doll_left1.png) *Doll* là Enemy di chuyển lúc nhanh lúc chậm ngẫu nhiên
- ![](res/sprites/kondoria_left1.png) *Kondoria*  là Enemy di chuyển ngẫu nhiên với khả năng đi xuyên qua đối tượng Brick
- ![](res/sprites/BPE_-_Ovape_29.webp) *Ovape* là Enemy di chuyển xuyên đối tượng Brick và theo đuổi Bomber bất kể khoảng cách.
